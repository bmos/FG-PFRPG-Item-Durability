...
--	End compatibility patch
	...
	divider4.setVisible((bSection1 or bSection2 or bSection3 or bSection3a or bSection4) and bSection5);
	divider5.setVisible((bSection1 or bSection2 or bSection3 or bSection3a or bSection4 or bSection5) and bSection6);
	if bPFRPGEILoaded and User.isHost() then
		divider6.setVisible((bSection1 or bSection2 or bSection3 or bSection3a or bSection4 or bSection5 or bSection6) and bSection7);
	end
	if bACIMisLoaded then
		divider8.setVisible((bSection1 or bSection2 or bSection3 or bSection3a or bSection4 or bSection5 or bSection6 or bSection7) and bSection8);
	end
end
